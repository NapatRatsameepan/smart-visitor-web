...
const mockFactoryData: Record<string, { name: string; address: string; status: string }> = {
  ...
  "3": {
    name: "โรงงานมิตรผล อยุธยา",
    address: "88 หมู่ 3 ตำบลบ้านแพน อำเภอเสนา จังหวัดพระนครศรีอยุธยา 13110",
    status: "active",
  },
  "4": {
    name: "โรงงานมิตรผล สุพรรณบุรี",
    address: "200 หมู่ 6 ตำบลดอนมะเกลือ อำเภออู่ทอง จังหวัดสุพรรณบุรี 72160",
    status: "active",
  },
  "5": {
    name: "โรงงานมิตรผล กาญจนบุรี",
    address: "145 หมู่ 2 ตำบลท่าขนุน อำเภอทองผาภูมิ จังหวัดกาญจนบุรี 71180",
    status: "active",
  },
  "6": {
    name: "โรงงานมิตรผล นครปฐม",
    address: "333 หมู่ 7 ตำบลนครปฐม อำเภอเมืองนครปฐม จังหวัดนครปฐม 73000",
    status: "active",
  },
  "7": {
    name: "โรงงานมิตรผล ขอนแก่น",
    address: "456 หมู่ 1 ตำบลโนนท่อน อำเภอเมืองขอนแก่น จังหวัดขอนแก่น 40000",
    status: "active",
  },
  "8": {
    name: "โรงงานมิตรผล อุบลราชธานี",
    address: "78 หมู่ 9 ตำบลกุดลาด อำเภอเมืองอุบลราชธานี จังหวัดอุบลราชธานี 34000",
    status: "active",
  },
  "9": {
    name: "โรงงานมิตรผล ลำพูน",
    address: "512 หมู่ 4 ตำบลบ้านกลาง อำเภอเมืองลำพูน จังหวัดลำพูน 51000",
    status: "inactive",
  },
  "10": {
    name: "โรงงานมิตรผล เชียงราย",
    address: "67 หมู่ 11 ตำบลรอบเวียง อำเภอเมืองเชียงราย จังหวัดเชียงราย 57000",
    status: "active",
  },
  "11": {
    name: "โรงงานมิตรผล พิษณุโลก",
    address: "321 หมู่ 8 ตำบลอรัญญิก อำเภอเมืองพิษณุโลก จังหวัดพิษณุโลก 65000",
    status: "active",
  },
  "12": {
    name: "โรงงานมิตรผล นครสวรรค์",
    address: "189 หมู่ 5 ตำบลนครสวรรค์ตก อำเภอเมืองนครสวรรค์ จังหวัดนครสวรรค์ 60000",
    status: "active",
  },
  "13": {
    name: "โรงงานมิตรผล ราชบุรี",
    address: "254 หมู่ 2 ตำบลหน้าเมือง อำเภอเมืองราชบุรี จังหวัดราชบุรี 70000",
    status: "inactive",
  },
  "14": {
    name: "โรงงานมิตรผล สุราษฎร์ธานี",
    address: "99 หมู่ 6 ตำบลตลาด อำเภอเมืองสุราษฎร์ธานี จังหวัดสุราษฎร์ธานี 84000",
    status: "active",
  },
  "15": {
    name: "โรงงานมิตรผล นครศรีธรรมราช",
    address: "430 หมู่ 3 ตำบลปากพูน อำเภอเมืองนครศรีธรรมราช จังหวัดนครศรีธรรมราช 80000",
    status: "active",
  },
  "16": {
    name: "โรงงานมิตรผล สงขลา",
    address: "77 หมู่ 10 ตำบลพะวง อำเภอเมืองสงขลา จังหวัดสงขลา 90100",
    status: "active",
  },
  "17": {
    name: "โรงงานมิตรผล กำแพงเพชร",
    address: "160 หมู่ 7 ตำบลในเมือง อำเภอเมืองกำแพงเพชร จังหวัดกำแพงเพชร 62000",
    status: "inactive",
  },
}
            ...
            <div className="mb-8">
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <Link
                    href={`/super-admin/factory/${id}/edit`}
