        ...
        <main className="flex-1 ml-0 dynamic-ml p-8 overflow-y-auto">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="flex items-center justify-between mb-6">
              ...
              <Link href="/super-admin/accounts/new" className="flex items-center gap-2 bg-slate-900 text-white px-5 py-2.5 rounded-full text-sm font-medium hover:bg-slate-800 transition-colors">
                ...
                <tbody>
                  {visibleAdmins.map((row) => (
                    <tr key={row.id} className="border-b border-slate-100 hover:bg-slate-50 transition-colors">
                      ...
                      <td className="py-4 px-3 text-center">
                        <Link href={`/super-admin/accounts/${row.id}/edit`} className="text-slate-400 hover:text-slate-700 transition-colors inline-block">
