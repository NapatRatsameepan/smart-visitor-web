            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div>
                <div className="flex items-center justify-between mb-6">
                  ...
                  <Link href="/admin/visit/new" className="flex items-center gap-2 bg-slate-900 text-white px-5 py-2.5 rounded-full text-sm font-medium hover:bg-slate-800 transition-colors">
                      ...
                      {mockVisits.map((row) => (
                        <tr key={row.id} className="border-b border-slate-100 hover:bg-slate-50 transition-colors">
                          ...
                          <td className="py-4 px-4 text-center">
                            <Link href={`/super-admin/visit/${row.id}/edit`} className="text-slate-400 hover:text-slate-700 transition-colors inline-block">
